...
| "Research references/examples and compare to this product" | Browser full task with web navigation | Source names, observed patterns, copy/adapt fixes | Generic web summary without product comparison |
...
- Internet research should be invoked when the user asks for references, examples, competitors, inspiration, copy/adapt lessons, or web research.
