...
bot.start(async (ctx) => {
  ...
  if (conversation.isAdmin(user)) {
    lines.push(
      ...
      '/status - Show authoritative Spark live status',
      '/diagnose - Run chat, access, relay, Spawner, and provider checks',
      '/schedule "<cron>" mission|loop ... - Create a cron-scheduled mission or chip loop',
      '/schedules - List, delete, or pause/resume scheduled missions',
