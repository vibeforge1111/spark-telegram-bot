...
bot.start(async (ctx) => {
  ...
  if (conversation.isAdmin(user)) {
    lines.push(
      ...
      '/chip create <description> - Scaffold a new domain chip from a brief',
      '/loop <chip_key> [rounds] - Run a self-improving autoloop on a chip',
      '/recursive <sessions|paths|status|compare|evidence|package> - Drive specialization-path recursion',
