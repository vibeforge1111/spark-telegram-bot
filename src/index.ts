...
bot.start(async (ctx) => {
  ...
  if (conversation.isAdmin(user)) {
    lines.push(
      ...
      '/runminimax <goal> - Pin a mission to MiniMax',
      '/runglm <goal> - Pin a mission to Z.AI GLM',
      '/runzai <goal> - Pin a mission to Z.AI GLM',
      '/runclaude <goal> - Pin a mission to Claude',
      '/runcodex <goal> - Pin a mission to Codex',
      '/run2 <goal> - Consensus run on minimax + zai',
      '/runall <goal> - Run on all four providers (minimax, zai, claude, codex)',
