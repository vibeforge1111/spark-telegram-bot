...
Attention summary:
- proof_panel_legacy_gap_stale: 8 cases

Recapture hint:
- Refresh /proof panel captures for: cp-web-002, cp-spawner-001, cp-spawner-002, cp-mission-001, cp-media-001, cp-media-002, cp-voice-001, cp-audio-001
