...
3. Attach proof capsules or proof refs to Telegram/action audit rows. First wire-in added for Telegram build/run acknowledgements and suppressed Builder final-answer rows in `src/index.ts`.
